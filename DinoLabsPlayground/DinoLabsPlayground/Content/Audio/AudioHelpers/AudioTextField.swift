...
struct AudioTextField: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> NSTextField {
        ...
        if isSecure {
            ...
            let normalField = AudioNSTextField()
    ...
    class Coordinator: NSObject, NSTextFieldDelegate {
        var parent: AudioTextField
        
        init(_ parent: AudioTextField) {
            self.parent = parent
        }
...
class AudioNSTextField: NSTextField {
    var onReturnKeyPressed: (() -> Void)? = nil
...
extension AudioNSTextField: NSTextViewDelegate {
