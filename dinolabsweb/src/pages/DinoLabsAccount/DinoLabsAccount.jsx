...
import { faArrowUpRightFromSquare, faUserGear, faUsersGear, faPersonChalkboard, faLock, faChartColumn, faMoneyBills, faGear, faPenToSquare, faClone, faSquareCheck, faHammer, faSquareXmark, faGlobe } from "@fortawesome/free-solid-svg-icons";
                                                ...
                                                {!activeAccessRequest && (
                                                    <div className="profileContentFlexCellElongated" style={{ border: createTeamError !== "" ? "1px solid #E54B4B" : "" }}>
                                                        <div className="profileContentFlexCellTop">
                                                            <div className="profileLeadingCellStack">
                                                                <h3>Create a Team</h3>
                                                                <p>If you are not a part of a team or orgnaization, you can create one here. Just enter a team name and you will be given administrative access as the founder.</p>
                                                            </div>
                                                            <div className="profileTrailingCellStack" style={{ justifyContent: "center", alignItems: "center" }}>
                                                                {isTeamCreateLoad ? (
                                                    ...
                                                    <div className="profileContentFlexCell">
                                                        <div className="profileContentFlexCellTop">
                                                            <div className="profileLeadingCellStack" style={{ width: "100%" }}>
                                                                ...
                                                                <p style={{ width: "100%" }}>
                                                                    Set up export notifications to be alerted whenver one of your your team members exports any of your data from the Stack Forge platform.
                                                                </p>
