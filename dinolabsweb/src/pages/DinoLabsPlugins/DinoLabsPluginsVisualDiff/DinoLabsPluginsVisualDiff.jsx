...
export default function DinoLabsPluginsVisualDiff() {
  ...
  const makePixelDiff = (aCtx, bCtx, W, H, thresh = 0.1, mode = "heat") => {
  ...
  const videoThumbnails = async (file, count = 12, maxW = 320, maxH = 180) => {
  ...
  const drawImageDiff = useCallback(async () => {
    ...
    const oRef = overlayCanvasRef.current; if (oRef) {
      oRef.width = W; oRef.height = H; const octx = oRef.getContext("2d");
