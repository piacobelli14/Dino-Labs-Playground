...
const Register = () => {
    ...
    const handleRegister = async () => {
        ...
        if (firstName !== "" && lastName !== "" && email !== "" && username !== "" && phone !== "") {
            ...
            try {
                const response = await fetch("https://www.dinolaboratories.com/dinolabs/dinolabs-web-api/validate-new-user-info", {
                    method: "POST",
                    headers: {
    ...
    const handlePassword = async () => {
        ...
        reader.onload = async () => {
            ...
            try {
                const response = await fetch("https://www.dinolaboratories.com/dinolabs/dinolabs-web-api/create-user", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                    },
            ...
            <div className="registerCellHeaderContainer" style={{"background": "linear-gradient(to left, #111111, #090011)"}}>
                {isPersonal && (
                    <div className="registerBlock">
                        <label className="registerTitle">Register New Account</label>
                        <label className="registerSubtitles">Enter your new account information below. </label>
                ...
                {isPassword && (
                    <div className="registerBlock">
                        <label className="resetTitle">Register New Account</label>
                        <label className="resetSubtitles">Enter and confirm the password for your new account. </label>
